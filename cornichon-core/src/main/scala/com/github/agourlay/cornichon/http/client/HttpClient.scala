...
import com.github.agourlay.cornichon.http.{ HttpResponse, HttpIsoStringRequest, HttpRequest, HttpStreamedRequest }
...
trait HttpClient {
  ...
  def runIsoStringRequest[A: Show, B: Show](cReq: HttpIsoStringRequest[A, B], t: FiniteDuration)(implicit ee: EntityEncoder[Task, A]): EitherT[Task, CornichonError, HttpResponse]
